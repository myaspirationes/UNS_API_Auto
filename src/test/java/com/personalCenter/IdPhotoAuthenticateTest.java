...
//证件照认证接口
	...
	String deleteSql2 = "DELETE FROM T_AUTH_PHOTO WHERE USER_ID = '12495079'";
	String updateSql0 = "UPDATE \"T_AUTH_PHOTO\" SET \"STATUS\"='1' WHERE USER_ID = '12495079'";
	String updateSql1 = "UPDATE \"T_AUTH_PHOTO\" SET \"STATUS\"='2' WHERE USER_ID = '12495079'";
	JSONObject body;
	String chcode;
	String uuid;
