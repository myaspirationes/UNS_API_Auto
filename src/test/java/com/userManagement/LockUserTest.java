...
// 锁定用户接口
	...
	public void postLockUserTestCorrectParameter() throws Exception {
		...
		assertThat(list.get(1).get("LOCK_TYPE").toString()).isEqualTo("2");
	 ...
	 */
	//@Test
	public void postLockOperatorTestOperatorNameIsEmpty() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
	 ...
	 */
	//@Test
	public void postLockOperatorTestOperatorNameIsSpace() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
	 ...
	 */
	//@Test
	public void postLockOperatorTestOperatorNameIsNull() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
	 ...
	 */
	//@Test
	public void postLockOperatorTestOperatorNameIsIllegalCharacters() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
	 ...
	 */
	//@Test
	public void postLockOperatorTestOperatorNameIsNonSubmissionParameters() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
	 ...
	 */
	@Test
	public void postLockOperatorTestOperatorIdIsError() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
		...
		request.put("userId", 12495396);
		request.put("operatorName", "BeJson");
		request.put("operatorId", 12491722);
		request.put("userLockDTO", lis);
		JSONObject post = super.UNSPost(url, request);
		System.out.println("处理人id为错误" + post);
	 ...
	 */
	@Test
	public void postLockOperatorTestOperatorIdIsLong() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
		...
		request.put("userId", 12495396);
		request.put("operatorName", "BeJson");
		request.put("operatorId", 999999999999999999L);
		request.put("userLockDTO", lis);
		JSONObject post = super.UNSPost(url, request);
		System.out.println("处理人id为超长" + post);
	 ...
	 */
	@Test
	public void postLockOperatorTestOperatorIdIsNegativeNumber() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
		...
		request.put("userLockDTO", lis);
		JSONObject post = super.UNSPost(url, request);
		System.out.println("处理人id为负数" + post);
	 ...
	 */
	@Test
	public void postLockOperatorTestOperatorIdIsDecimal() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
		...
		request.put("userId", 12495396);
		request.put("operatorName", "BeJson");
		request.put("operatorId", 12.491738);
		request.put("userLockDTO", lis);
		JSONObject post = super.UNSPost(url, request);
		System.out.println("处理人id为小数" + post);
	 ...
	 */
	@Test
	public void postLockOperatorTestOperatorIdIsZero() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
		...
		request.put("userLockDTO", lis);
		JSONObject post = super.UNSPost(url, request);
		System.out.println("处理人id为0" + post);
	 ...
	 */
	@Test
	public void postLockOperatorTestOperatorIdIsEmpty() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
		...
		request.put("userLockDTO", lis);
		JSONObject post = super.UNSPost(url, request);
		System.out.println("处理人id为空" + post);
	 ...
	 */
	@Test
	public void postLockOperatorTestOperatorIdIsSpace() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
		...
		request.put("userLockDTO", lis);
		JSONObject post = super.UNSPost(url, request);
		System.out.println("处理人id为空格" + post);
	 ...
	 */
	@Test
	public void postLockOperatorTestOperatorIdIsNull() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
		...
		request.put("userLockDTO", lis);
		JSONObject post = super.UNSPost(url, request);
		System.out.println("处理人id为null" + post);
	 ...
	 */
	@Test
	public void postLockOperatorTestOperatorIdIsString() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
		...
		request.put("userId", 12495396);
		request.put("operatorName", "BeJson");
		request.put("operatorId", "dfdfas");
		request.put("userLockDTO", lis);
		JSONObject post = super.UNSPost(url, request);
		System.out.println("处理人id为String" + post);
	 ...
	 */
	@Test
	public void postLockOperatorTestOperatorIdNonSubmissionParameters() throws Exception {
		MetaOper.read(selectSql, dataType);
		map1.put("lockType", 0);
		map1.put("lockTime", 1);
		map1.put("opinion", "测试3");
		...
		request.put("userLockDTO", lis);
		JSONObject post = super.UNSPost(url, request);
		System.out.println("处理人id不传" + post);
