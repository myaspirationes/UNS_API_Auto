...
//		request.put("keyWord", "xx");
		...
		assertThat(post.get("status")).isEqualTo(1);
		assertThat(post.get("msg")).isEqualTo("校验失败");
	}
...
//		request.put("keyWord", "xx");
		...
		assertThat(post.get("status")).isEqualTo(1);
		assertThat(post.get("msg")).isEqualTo("当前页,格式违法");
	}
	/**
	 * 当前页数为字符串
	 */
...
//		request.put("keyWord", "xx");
		...
		assertThat(post.get("status")).isEqualTo(1);
		assertThat(post.get("msg")).isEqualTo("每页显示不能为空或小于零");
	}
	/**
	 * 每页条数为字符串
	 */
...
//		request.put("keyWord", "xx");
		...
		assertThat(post.get("status")).isEqualTo(1);
		assertThat(post.get("msg")).isEqualTo("用户id校验失败");
	}
	/**
	 * 操作用户ID为字符串
	 */
